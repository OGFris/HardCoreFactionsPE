...
class Spider extends Monster {
	...
	public function getDrops(): array{
		...
		if($this->lastDamageCause instanceof EntityDamageByEntityEvent and ($this->lastDamageCause->getEntity() instanceof MDPlayer || $this->lastDamageCause->getEntity() instanceof Human)){
			if(mt_rand(0, 199) < 5){
				switch(mt_rand(0, 2)){
					case 0:
